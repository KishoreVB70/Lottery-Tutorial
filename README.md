...
One of the services that oracles provide is randomness generation. Through oracles, smart contracts can obtain tamper-proof random numbers. Every oracle has a different way of generating the randomness. We are going to learn how to generate a random number using Witnet
## Witnet Oracle
